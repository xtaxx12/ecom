...
public class AdminOrderServiceImpl implements AdminOrderService {
    ...
    public AnalyticsResponse calculateAnalytics() {
        ...
        Long previousMonthOrders=getTotalEarningsForMonth(previousMonthDate.getMonthValue(), previousMonthDate.getYear());
    ...
    public Long getTotalOrdersForMonth(int month, int year) {
        ...
        //Move the calendar to the end of the specific month
